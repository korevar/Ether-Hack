...
EtherAdminPanel = ISPanel:derive("EtherAdminPanel");
...
function EtherAdminPanel:initialise()
    ISPanel.initialise(self);
    self:create();
end


function EtherAdminPanel:setVisible(visible)
    --    self.parent:setVisible(visible);
    self.javaObject:setVisible(visible);
end

function EtherAdminPanel:render()
    local z = 20;
...
function EtherAdminPanel:create()
    local btnWid = 150
    ...
    -- if isCoopHost() then
        self.beAdmin = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_EnableAdminPower"), self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.dbBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_SeeDB"), self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.checkStatsBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_CheckYourStats"), self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.adminPowerBtn = ISButton:new(10, y, btnWid, btnHgt, title, self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.itemListBtn = ISButton:new(10, y, btnWid, btnHgt, title, self, EtherAdminPanel.onOptionMouseDown);
...
--    self.itemListBtn.tooltip = getText("IGUI_AdminPanel_TooltipEditAdminPower");
    ...
    y = y + btnHgt + btnGapY
    self.seeOptionsBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_SeeServerOptions"), self, EtherAdminPanel.onOptionMouseDown);
    ...
    y = y + btnHgt + btnGapY
    -- if getAccessLevel() == "admin" then
        self.nonpvpzoneBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_NonPvpZone"), self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.seeFactionBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_SeeFaction") .. " (" .. Faction.getFactions():size() ..")", self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.seeSafehousesBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_SeeSafehouses") .. " (".. SafeHouse.getSafehouseList():size() .. ")", self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.safezoneBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_Safezone"), self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.seeTicketsBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_SeeTickets"), self, EtherAdminPanel.onOptionMouseDown);
    ...
    self.miniScoreboardBtn = ISButton:new(10, y, btnWid, btnHgt, getText("IGUI_AdminPanel_MiniScoreboard"), self, EtherAdminPanel.onOptionMouseDown);
    ...
    y = 70
    self.packetCountsBtn = ISButton:new(10 + btnWid + 20, y, btnWid, btnHgt, getText("IGUI_AdminPanel_PacketCounts"), self, EtherAdminPanel.onOptionMouseDown)
    ...
    self.sandboxOptionsBtn = ISButton:new(10 + btnWid + 20, y, btnWid, btnHgt, getText("IGUI_AdminPanel_SandboxOptions"), self, EtherAdminPanel.onOptionMouseDown)
    ...
    self.climateOptionsBtn = ISButton:new(10 + btnWid + 20, y, btnWid, btnHgt, getText("IGUI_Adm_Weather_ClimateControl"), self, EtherAdminPanel.onOptionMouseDown)
    ...
    self.showStatisticsBtn = ISButton:new(10 + btnWid + 20, y, btnWid, btnHgt, getText("IGUI_AdminPanel_ShowStatistics"), self, EtherAdminPanel.onOptionMouseDown)
    ...
    self.cancel = ISButton:new((self:getWidth() - btnWid) / 2, bottom + btnGapY, btnWid, btnHgt, getText("UI_btn_close"), self, EtherAdminPanel.onOptionMouseDown);
...
function EtherAdminPanel:updateButtons()
    local enabled = false;
...
function EtherAdminPanel:removeAdmin()
    setAdmin();
    self.beAdmin.title = getText("IGUI_AdminPanel_EnableAdminPower");
    self:updateButtons();
end

function EtherAdminPanel:onOptionMouseDown(button, x, y)
    ...
    if button.internal == "BEADMIN" then
        ...
        -- if getAccessLevel() == "admin" then
            self.beAdmin.title = getText("IGUI_AdminPanel_DisableAdminPower");
            self.adminModal = ISModalDialog:new(getCore():getScreenWidth() / 2 - 250,getCore():getScreenHeight() - 155, 500, 150, getText("IGUI_AdminPanel_ModalAdminPower"), false, self, EtherAdminPanel.removeAdmin);
...
function EtherAdminPanel:close()
    self:setVisible(false);
    self:removeFromUIManager();
    EtherAdminPanel.instance = nil
end

function EtherAdminPanel:new(x, y, width, height)
    local o = {};
    ...
    EtherAdminPanel.instance = o
    return o;
end

function EtherAdminPanel.OnSafehousesChanged()
    if EtherAdminPanel.instance then
        local button = EtherAdminPanel.instance.seeSafehousesBtn
        button:setTitle( getText("IGUI_AdminPanel_SeeSafehouses") .. " (".. SafeHouse.getSafehouseList():size() .. ")" )
    end
end

Events.OnSafehousesChanged.Add(EtherAdminPanel.OnSafehousesChanged)
